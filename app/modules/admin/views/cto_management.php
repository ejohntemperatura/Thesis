            ...
            if (this.value && description) {
                ...
                if (oneYearExpiryTypes.includes(this.value)) {
                    ...
                    if (noExpiryRadio && noExpiryLabel) {
                        ...
                        noExpiryLabel.classList.remove('cursor-pointer', 'hover:bg-slate-700');
                    }
                    if (oneYearRadio && oneYearLabel) {
                        ...
                        oneYearLabel.classList.add('cursor-pointer', 'hover:bg-slate-700');
                    }
                } else {
                    ...
                    if (noExpiryRadio && noExpiryLabel) {
                        ...
                        noExpiryLabel.classList.add('cursor-pointer', 'hover:bg-slate-700');
                    }
                    if (oneYearRadio && oneYearLabel) {
                        oneYearRadio.checked = false;
                        oneYearRadio.disabled = true;
                        oneYearLabel.classList.add('opacity-50', 'cursor-not-allowed');
                        oneYearLabel.classList.remove('cursor-pointer', 'hover:bg-slate-700');
                    }
                }
                ...
                allLabels.forEach(label => {
                    ...
                    label.classList.add('cursor-pointer', 'hover:bg-slate-700');
                });
            }
        });
